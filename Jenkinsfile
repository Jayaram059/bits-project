        ...
        stage('Update OCI Func') {
            steps {
                script {
                    ...
                    //&& fn inspect context bits-new && fn use context bits-new && fn update context registry  hyd.ocir.io/axvjenufkdre/bits-genai &&
                    bat "fn list context && fn update function fn-bits-new fn-bits-trail --image ${ociRegistry}:${BUILD_NUMBER}"
